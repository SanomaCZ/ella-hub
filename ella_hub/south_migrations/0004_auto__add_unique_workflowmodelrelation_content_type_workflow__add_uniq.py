...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'WorkflowModelRelation', fields ['content_type', 'workflow']
        db.create_unique(u'ella_hub_workflowmodelrelation', ['content_type_id', 'workflow_id'])

        # Adding unique constraint on 'WorkflowPermissionRelation', fields ['permission', 'workflow']
        db.create_unique(u'ella_hub_workflowpermissionrelation', ['permission_id', 'workflow_id'])

        # Adding unique constraint on 'StatePermissionRelation', fields ['state', 'role', 'permission']
        db.create_unique(u'ella_hub_statepermissionrelation', ['state_id', 'role_id', 'permission_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'StatePermissionRelation', fields ['state', 'role', 'permission']
        db.delete_unique(u'ella_hub_statepermissionrelation', ['state_id', 'role_id', 'permission_id'])

        # Removing unique constraint on 'WorkflowPermissionRelation', fields ['permission', 'workflow']
        db.delete_unique(u'ella_hub_workflowpermissionrelation', ['permission_id', 'workflow_id'])

        # Removing unique constraint on 'WorkflowModelRelation', fields ['content_type', 'workflow']
        db.delete_unique(u'ella_hub_workflowmodelrelation', ['content_type_id', 'workflow_id'])
