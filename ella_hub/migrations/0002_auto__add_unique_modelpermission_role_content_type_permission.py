...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ModelPermission', fields ['role', 'content_type', 'permission']
        db.create_unique('ella_hub_modelpermission', ['role_id', 'content_type_id', 'permission_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ModelPermission', fields ['role', 'content_type', 'permission']
        db.delete_unique('ella_hub_modelpermission', ['role_id', 'content_type_id', 'permission_id'])
